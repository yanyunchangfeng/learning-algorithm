...
1. [time complexity(Upper)](src/assets/img/lesson1.png)  
2. [time complexity(Lower)](src/assets/img/lesson2.png)  
3. [Array](src/assets/img/lesson3.png)  
4. [Linkedlist(Upper)](src/assets/img/lesson4.png) 
5. [Linkedlist(Lower)](src/assets/img/lesson5.png)  | [Dynamic flow chart js](src/app/lesson5/linkedlist.html)
6. [Stack](src/assets/img/lesson6.png) 
...
11. [Linear Sort](src/assets/img/lesson11.png) 
12. [Sort majorization](src/assets/img/lesson12.png) 
13. [Binary Search (upper)](src/assets/img/lesson13.png) 
14. [Binary Search (lower)](src/assets/img/lesson14.png) 
15. [Skip list](src/assets/img/lesson15.png) 
16. [Hash Table(upper)](src/assets/img/lesson16.png) 
